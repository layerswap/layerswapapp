...
const ImtblRedirect = () => {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col items-center justify-center gap-5 p-6 text-primary-text bg-gradient-to-b from-secondary-900 to-secondary-500">
