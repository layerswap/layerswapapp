...
module.exports = (phase, { defaultConfig }) => {
  ...
  const nextConfig = {
    ...
    transpilePackages: ['@imtbl/auth', '@imtbl/wallet', '@imtbl/metrics', '@imtbl/toolkit', '@imtbl/generated-clients', '@fuels/connectors', '@fuels/react', "@radix-ui/react-dismissable-layer", "@solana/web3.js"]
  }
