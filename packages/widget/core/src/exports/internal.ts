...
export type { DisplayUriSource, WalletConnectRegistryConnector, WalletConnectWalletBase, WalletConnectWallet, Eip6963Provider, isProviderConnectReady } from "@layerswap/wallet-core";
