...
const BlankHistory = ({ onNewTransferClick }: BlankHistoryProps) => (
    <HistoryEmptyState
        ...
        action={
            <a onClick={onNewTransferClick} href={"/"} className="flex items-center gap-2 text-base text-secondary-text font-normal bg-secondary-500 hover:bg-secondary-400 py-2 px-3 rounded-lg">
