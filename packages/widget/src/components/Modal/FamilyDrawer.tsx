...
// ============================================================================
// Demo  (delete everything below to use FamilyDrawer on its own)
// ============================================================================

function badge(path: ReactNode) {
  return (
...
function DefaultView() {
  ...
  return (
    <>
      <FamilyDrawerClose />
      <FamilyDrawerHeader
        icon={badge(<><circle cx="12" cy="12" r="3" {...stroke} /><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.6a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1Z" {...stroke} /></>)}
        title="Settings"
      ...
      <div style={{ marginTop: 20 }}>
        <FamilyDrawerRow
          ...
          icon={badge(<><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" {...stroke} /><circle cx="12" cy="7" r="4" {...stroke} /></>)}
        >
          Account
        </FamilyDrawerRow>
        <FamilyDrawerRow
          onClick={() => setView("notifications")}
          icon={badge(<><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" {...stroke} /><path d="M13.7 21a2 2 0 0 1-3.4 0" {...stroke} /></>)}
        >
          Notifications
        </FamilyDrawerRow>
        <FamilyDrawerRow
          onClick={() => setView("appearance")}
          icon={badge(<><circle cx="12" cy="12" r="4" {...stroke} /><path d="M12 2v2M12 20v2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M2 12h2M20 12h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4" {...stroke} /></>)}
        >
          Appearance
        </FamilyDrawerRow>
        <FamilyDrawerRow
          onClick={() => setView("help")}
          icon={badge(<><circle cx="12" cy="12" r="10" {...stroke} /><path d="M9.1 9a3 3 0 0 1 5.8 1c0 2-3 3-3 3" {...stroke} /><path d="M12 17h.01" {...stroke} /></>)}
        >
          Help &amp; feedback
        </FamilyDrawerRow>
      </div>
...
function AccountView() {
  return (
    <>
      <FamilyDrawerBack />
      <FamilyDrawerClose />
      <FamilyDrawerHeader title="Account" />
      <div
        style={{
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        <div>
          <div style={{ fontWeight: 600, fontSize: 16 }}>Alex Morgan</div>
          <div style={{ color: "var(--fd-muted-fg)", fontSize: 14 }}>
            alex@example.com
          </div>
        </div>
      </div>
      <div style={{ marginTop: 16, display: "grid", gap: 6 }}>
        <FamilyDrawerPrimaryButton>Manage subscription</FamilyDrawerPrimaryButton>
        <FamilyDrawerSecondaryButton>Sign out</FamilyDrawerSecondaryButton>
      </div>
    </>
  );
}
    ...
    >
      ...
      <span
        style={{
          ...
          height: 26,
          borderRadius: 9999,
          background: on ? "var(--fd-primary)" : "var(--fd-border)",
          position: "relative",
...
function AppearanceView() {
  ...
  return (
    <>
      <FamilyDrawerBack />
      <FamilyDrawerClose />
      <FamilyDrawerHeader title="Appearance" />
      <div style={{ marginTop: 18, display: "grid", gap: 8 }}>
        {options.map((o) => (
          <button
            key={o.id}
...
function HelpView() {
  return (
    <>
      <FamilyDrawerBack />
      <FamilyDrawerClose />
      <FamilyDrawerHeader title="Help &amp; feedback" />
      <p
        style={{
          marginTop: 16,
          fontSize: 15,
      ...
      >
        Stuck on something or have an idea? Our team usually replies within a
        few hours.
      </p>
      <div style={{ marginTop: 16 }}>
        <FamilyDrawerPrimaryButton>Contact support</FamilyDrawerPrimaryButton>
      </div>
    </>
  );
}

const demoViews: ViewsRegistry = {
  default: DefaultView,
  account: AccountView,
    ...
    >
      <FamilyDrawer
        ...
        trigger={
          <button
            type="button"
            className="navigation-focus-ring-text-bold-lg enabled:active:animate-press-down rounded-full bg-primary-500 px-6 py-2.5 text-sm font-medium text-primary-buttonTextColor transition duration-200 ease-in-out hover:brightness-110 focus:outline-none"
          >
            Open drawer
          </button>
        }
