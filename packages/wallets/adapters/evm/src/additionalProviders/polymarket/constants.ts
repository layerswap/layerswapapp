...
/**
 * Polymarket Gnosis Safe factory on Polygon, from `getContractConfig(137)` in
 ...
 * (MultiSend + deposit-wallet factory live in `./protocol`, re-exported above.)
 */
...
/** Deposit-wallet implementation (the modern ERC-1967 account funder —
