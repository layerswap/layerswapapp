...
export function useFeaturedProviders({ providers, selectedProvider, setSelectedProvider, }: UseFeaturedProvidersParams) {
    ...
    return { featuredProviders, filteredProviders, selectedProviderNames, selectProviders, }
}
