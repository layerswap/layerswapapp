...
connector.type = 'walletConnect' as const
...
function connector(parameters: WalletConnectParameters) {
    return createConnector<Provider, Properties, StorageItem>((config) => {
        // Move all state variables inside the createConnector scope so they are isolated for each instance
        ...
        return ({
             ...
             * initially requested by the connector for the WalletConnect sessionsession.
