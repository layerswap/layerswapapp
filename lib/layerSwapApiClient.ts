...
export default class LayerSwapApiClient {
  ...
  constructor() {
    this._authInterceptor = InitializeAuthInstance(
      LayerSwapAuthApiClient.identityBaseEndpoint
    );
    this._unauthInterceptor = InitializeUnauthInstance(
  ...
  async GetRoutesAsync(
    direction: "sources" | "destinations"
  ): Promise<ApiResponse<NetworkWithTokens[]>> {
    return await this.UnauthenticatedRequest<ApiResponse<NetworkWithTokens[]>>(
      "GET",
      `/${direction}`
    );
  }
  ...
  async GetSourceExchangesAsync(): Promise<ApiResponse<Exchange[]>> {
    return await this.UnauthenticatedRequest<ApiResponse<Exchange[]>>(
      "GET",
      `/source_exchanges`
    );
  }
  ...
  async CreateSwapAsync(
    ...
    return await this.AuthenticatedRequest<ApiResponse<SwapResponse>>(
      "POST",
      `/swaps`,
      params,
  ...
  async GetSwapsAsync(
    ...
    return await this.AuthenticatedRequest<ApiResponse<SwapResponse[]>>(
      "GET",
      `/internal/swaps?page=${page}&include_expired=${include_expired}`
    );
  }

  async GetExplorerSwapsAsync(
    address: string
  ): Promise<ApiResponse<SwapResponse[]>> {
    return await this.UnauthenticatedRequest<ApiResponse<SwapResponse[]>>(
      "GET",
      `/explorer/${address}?version=sandbox`
    );
  }
  ...
  async GetQuote({
    ...
    return await this.AuthenticatedRequest<ApiResponse<Quote>>(
      "GET",
      `/quote?source_network=${source_network}&source_token=${source_token}&source_address=${source_address}&destination_network=${destination_network}&destination_token=${destination_token}&use_deposit_address=${use_deposit_address}&include_gas=${include_gas}&amount=${amount}&refuel=${refuel}`
    );
  }
  ...
  async DisconnectExchangeAsync(
    ...
    return await this.AuthenticatedRequest<ApiResponse<void>>(
      "DELETE",
      `/internal/swaps/${swapid}/exchange/${exchangeName}/disconnect`
    );
  }
  ...
  async GetDepositAddress(
    ...
    return await this.AuthenticatedRequest<ApiResponse<DepositAddress>>(
      "GET",
      `/internal/swaps?network=${network}&source=${source}`
    );
  }
  ...
  async WithdrawFromExchange(
    ...
    return await this.AuthenticatedRequest<ApiResponse<void>>(
      "POST",
      `/internal/swaps/${swapId}/exchange/${exchange}/withdraw${
  ...
  async GetTransactionStatus(
    ...
    return await this.AuthenticatedRequest<ApiResponse<any>>(
      "POST",
      `/internal/networks/${network}/transaction_status`,
  ...
  private async UnauthenticatedRequest<T extends EmptyApiResponse>(
    method: Method,
    endpoint: string,
    data?: any,
    header?: {}
