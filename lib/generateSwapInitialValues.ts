...
export function generateSwapInitialValues(swapType: SwapType, settings: LayerSwapSettings, queryParams: QueryParams): SwapFormValues {
    ...
    return { currency: initialCurrency, destination_address: initialSwapType == SwapType.OnRamp && initialAddress, swapType: initialSwapType, network: initialNetwork, exchange: initialExchange }
}