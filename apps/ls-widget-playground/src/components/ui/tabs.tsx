...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "tw-inline-flex tw-items-center tw-justify-center tw-rounded-lg tw-bg-muted tw-p-1.5 tw-text-muted-foreground",
      className
    )}
    {...props}
  />
