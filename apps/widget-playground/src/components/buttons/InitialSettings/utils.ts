...
export const PARAM_OPTIONS = [
    ...
    { value: "fromExchange", label: "From exchange", type: "select" as FieldType },
    ...
    { value: "hideAddress", label: "Hide address", type: "boolean" as FieldType },
    { value: "hideFrom", label: "Hide from", type: "boolean" as FieldType },
    { value: "hideTo", label: "Hide to", type: "boolean" as FieldType },
    { value: "hideDepositMethod", label: "Hide deposit method", type: "boolean" as FieldType },
    { value: "hideLogo", label: "Hide logo", type: "boolean" as FieldType },
    { value: "lockNetwork", label: "Lock network", type: "boolean" as FieldType },
    { value: "lockExchange", label: "Lock exchange", type: "boolean" as FieldType },
    ...
    { value: "theme", label: "Theme", type: "text" as FieldType },
    ...
    { value: "coinbase_redirect", label: "Coinbase redirect", type: "text" as FieldType },
];
