...
// import { SwapContextData, SwapDataStateContext, SwapDataUpdateContext } from '../context/swap';
...
// window.plausible = () => { }
// const Comp: FC<{ settings: any, swapData: SwapContextData, failedSwap?: SwapItem, theme?: "default" | "light", initialValues?: SwapFormValues, timestamp?: string }> = ({ settings, swapData, theme, initialValues, timestamp }) => {
//     const formikRef = useRef<FormikProps<SwapFormValues>>(null);
//     const appSettings = new LayerSwapAppSettings(Settings)
//     const swapContextInitialValues: SwapContextData = { codeRequested: false, swapResponse: swapData.swapResponse, depositAddressIsFromAccount: false, withdrawType: undefined, swapTransaction: undefined }
