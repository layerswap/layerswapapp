    ...
    return (
        ...
        >
            ...
            <Drawer.Portal>
                ...
                <Drawer.Content
                    data-testid="content"
                    className={clsx('fixed sm:absolute flex flex-col bg-secondary-700 rounded-t-3xl bottom-0 left-0 right-0 h-full z-51 pb-4 text-primary-text ring-0! outline-hidden! ', className, {
