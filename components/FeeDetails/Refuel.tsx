...
const RefuelToggle: FC<RefuelProps> = ({ onButtonClick }) => {
    ...
    return (
        <ResizablePanel>
            <div className={`gap-4 flex relative items-center outline-hidden w-full text-primary-text px-3.5 py-2.5 border border-transparent transition-colors duration-200 rounded-t-lg ${needRefuel && 'border-b-3 !border-primary'}`}>
