...
export const generateExchangeMenuItems = ({ exchanges, networks, values, resource_storage_url, sourceExchangeName }: ExchangeMenuItemsProps): SelectMenuItem<Exchange>[] => {
    const { swapType, from, to } = values
    ...
    const menuItems: SelectMenuItem<Exchange>[] = exchanges
        ...
        .map(e => ({
            ...
            isAvailable: !isSourceExchangeAvailable,
            isDefault: false
        })).sort(SortingByOrder);
