...
const Widget = ({ children, className, hideMenu }: Props) => {
   ...
   return <div id="widget" className="relative p-px">
      ...
      <div  className='md:shadow-lg rounded-3xl w-full sm:overflow-hidden relative bg-gradient-to-b from-secondary-700 to-secondary-700'>
