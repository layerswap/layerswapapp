            ...
            <div className="flex flex-col px-4 md:px-8 py-6 text-primary-text font-light">
                <div>
                    ...
                    <p className="text-base mt-2">
                        Move crypto from Coinbase, Binance or Kraken to zkSync, Loopring, StarkNet and other L2s. <a className='underline hover:no-underline cursor-pointer plausible-event-name=Read+more' href='https://docs.layerswap.io/user-docs/' target='_blank'>Read more</a>
                    </p>
