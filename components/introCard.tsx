        ...
        <CardContainer {...props} >
            <div className="flex flex-col px-6 py-6 text-primary-text font-light">
                <div>
                    ...
                    <a target="_blank" href="https://twitter.com/layerswap/status/1666102958516215809?s=20" className="mt-3 inline-flex group items-center rounded-lg border border-secondary-500  bg-secondary-600 p-1 pr-2 text-white sm:text-base lg:text-sm xl:text-base">
