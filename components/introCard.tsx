        ...
        <CardContainer {...props} >
            <div className="flex flex-col px-4 md:px-8 py-6 text-primary-text font-light">
                <div>
                    ...
                    <a target="_blank" href="https://twitter.com/layerswap/status/1635399138316627969" className="mt-3 inline-flex group items-center rounded-lg border border-darkblue-500  bg-darkblue-600 p-1 pr-2 text-white sm:text-base lg:text-sm xl:text-base">
