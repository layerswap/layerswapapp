            ...
            <div className="flex flex-col px-4 md:px-8 py-6 text-primary-text font-light">
                <div>
                    ...
                    <p className="text-base mt-2">
                        Move crypto from Coinbase, Binance or Kraken to zkSync, Loopring, StarkNet and other L2s. <span className='underline hover:no-underline cursor-pointer plausible-event-name=Read+more' onClick={handleOpenModal}>Read more</span>
                    </p>
