        ...
        <CardContainer {...props} >
            <div className="flex flex-col px-6 py-6 text-primary-text font-light">
                <div>
                    ...
                    <a target="_blank" href="https://docs.layerswap.io/user-docs/using-layerswap/usdop-rewards" className="mt-3 inline-flex group items-center rounded-lg border border-secondary-500  bg-secondary-600 p-1 pr-2 text-white sm:text-base lg:text-sm xl:text-base">
