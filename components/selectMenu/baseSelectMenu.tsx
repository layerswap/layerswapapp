...
let BaseSelectMenu: FC<SelectMenuProps> = ({ name, value, values, setFieldValue, label, disabled, children, showNotAvailableMessage }) => {
    ...
    return (
        <Listbox disabled={disabled} value={value.id} onChange={onChangeHandler}>
            ...
            <div className="mt-1 relative">
                {children}
                <SelectMenuOptions name={name} values={values} showNotAvailableMessage={showNotAvailableMessage} />
            </div>
        </Listbox>
    )
}
