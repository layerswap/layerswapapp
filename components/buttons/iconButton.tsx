...
const IconButton = forwardRef<HTMLButtonElement | HTMLAnchorElement, IconButtonProps>(({ className, icon, ...props }, ref) => {
    ...
    return (
        <button {...theirProps} type="button" className={classNames("-mx-2 p-1.5 justify-self-start text-primary-text hover:bg-secondary-500 hover:text-white focus:outline-none inline-flex rounded-lg items-center", className)}>
            <div className='mx-1'>
                <div>
                    {icon}
                </div>
