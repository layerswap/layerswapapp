...
function TransactionsHistory() {
  ...
  return (
    <div id="widget" className='bg-secondary-700 sm:shadow-card sm:relative rounded-lg w-full text-primary-text overflow-y-auto sm:overflow-hidden max-h-screen h-full sm:h-[650px]'>
