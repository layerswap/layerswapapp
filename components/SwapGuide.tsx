...
const SwapGuide = ({ swap }: { swap: SwapItem }) => {
    return (
        <div className='rounded-md w-full flex flex-col items-left justify-center space-y-4 text-left text-secondary-text'>
            <p className='text-secondary-text'>To complete the swap, <strong>manually send</strong> assets from your wallet, to the <strong>Deposit Address</strong> generated by Layerswap.</p>
            <div className='space-y-3'>
                ...
                <div className='space-y-5 text-base text-secondary-text'>
                    ...
                    <div className='space-y-3'>
                        <p><span className='text-primary'>.02</span> Send <span className='text-primary-text'>{swap?.destination_network_asset}</span> to that address from your {swap?.source_exchange ? 'exchange account' : 'wallet'}</p>
                        <div className='border-2 border-secondary-400 rounded-xl p-2 bg-secondary-500'>
