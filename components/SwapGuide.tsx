...
const SwapGuide = ({ swap }: { swap: SwapItem }) => {
    return (
        <div className='rounded-md w-full flex flex-col items-left justify-center space-y-4 text-left text-primary-text'>
            <p className='text-primary-text'><span>To complete the swap,&nbsp;</span><strong>manually send</strong><span>&nbsp;assets from your wallet, to the&nbsp;</span><strong>Deposit Address</strong><span>&nbsp;generated by Layerswap.</span></p>
            <div className='space-y-3'>
                ...
                <div className='space-y-5 text-base text-primary-text'>
                    ...
                    <div className='space-y-3'>
                        <p><span className='text-primary'>.02</span><span>&nbsp;Send&nbsp;</span><span className='text-white'>{swap?.destination_network_asset}</span><span>&nbsp;to that address from your&nbsp;</span><span>{swap?.source_exchange ? 'exchange account' : 'wallet'}</span></p>
                        <div className='border-2 border-secondary-400 rounded-xl p-2 bg-secondary-500'>
