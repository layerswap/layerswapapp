...
const Wrapper: FC<SwapInfoProps> = ({ sourceAccountAddress, sourceCurrency, destinationCurrency, source: from, destination: to, requestedAmount, destinationAddress, refuel, exchange_account_connected, exchange_account_name, destExchange, sourceExchange, receiveAmount }) => {
