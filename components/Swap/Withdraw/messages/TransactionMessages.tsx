...
const GaslessUnavailableMessage: FC = () => {
    return <WalletMessage
        status="error"
        header='Gasless transfer unavailable'
        details={`Gasless transfers aren't available for this route right now. Switch to a standard transfer to continue — you'll pay the network fee yourself.`} />
}
