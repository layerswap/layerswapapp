                ...
                description: <div className='flex items-center space-x-1'>
                    ...
                    <div className='underline hover:no-underline flex items-center space-x-1'>
                        {swapRefuelTransaction && <>
                            <a target={"_blank"} href={swapRefuelTransaction?.explorer_url ?? output_tx_explorer?.replace("{0}", swapRefuelTransaction.transaction_id)}>{shortenAddress(swapRefuelTransaction?.transaction_id)}</a>
                            <ExternalLink className='h-4' />
                        </>}
                    </div>
                </div>
