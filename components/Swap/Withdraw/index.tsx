...
const Withdraw: FC = () => {
    ...
    const { signature, appName } = useQueryState()
    ...
    const walletIsAvailable = !isFiat
        ...
        && (sourceNetworkType === NetworkType.EVM
            ...
            || sourceIsImmutableX || sourceIsLoopring || sourceIsZkSync)
...
const WalletTransferContent: FC = () => {
    ...
    const { starknetAccount, imxAccount, lprAccount, syncWallet } = useWalletState()
    const { setStarknetAccount, setImxAccount, setLprAccount, setSyncWallet } = useWalletUpdate()
