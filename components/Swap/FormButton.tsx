        ...
        return (
            <div>
                <Address partner={partner}>
                    {() => (
                        <div className="border border-primary disabled:border-primary-900 items-center space-x-1 disabled:text-primary-actionButtonText/40 disabled:bg-primary-900 disabled:cursor-not-allowed relative w-full flex justify-center font-semibold rounded-md transform hover:brightness-125 transition duration-200 ease-in-out bg-primary text-primary-buttonTextColor py-3 px-2 md:px-3 plausible-event-name=Swap+initiated">
