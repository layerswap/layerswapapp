                                ...
                                }
                                {
                                    ...
                                    userType == UserType.AuthenticatedUser ?
                                        ...
                                        <>
                                            ...
                                            {
                                                router.pathname != '/' &&
                                                <Link href="/" className="menu-link my-1 flex relative cursor-pointer select-none items-center rounded-md px-4 py-2.5 outline-none bg-secondary-700 text-primary-text hover:text-white">
                                            ...
                                            {!embedded && router.pathname != '/campaigns' &&
                                                <Link href="/campaigns" className="menu-link my-1 flex relative cursor-pointer select-none items-center rounded-md px-4 py-2.5 outline-none bg-secondary-700 text-primary-text hover:text-white">
                                            ...
                                            <Link
                                                ...
                                                target="_blank"
                                                className="menu-link my-1 flex relative cursor-pointer select-none items-center rounded-md px-4 py-2.5 outline-none bg-secondary-700 text-primary-text hover:text-white"
                                            >
                                ...
                                }
                                {
                                    ...
                                    <>
                                        ...
                                        <button
                                            ...
                                            className="menu-link my-1 w-full flex relative cursor-pointer select-none items-center rounded-md px-4 py-2.5 outline-none bg-secondary-700 text-primary-text hover:text-white"
                                        >
