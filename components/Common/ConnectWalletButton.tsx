...
const ConnectWalletButton: FC<Props> = ({ provider, onConnect, descriptionText, ...rest }) => {
    ...
    >
        <div tabIndex={-1} className="flex flex-row justify-between gap-9 items-stretch">
            ...
            />
            <div tabIndex={-1} className="h-full space-y-2">
                ...
                <div tabIndex={-1} className="bg-primary-700/30 border-none text-primary! py-2 rounded-lg text-base font-semibold">
                    {
                        !isProviderReady ?
