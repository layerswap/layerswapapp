...
export default function SelectItem({ item }: { item: ISelectMenuItem }) {
    ...
    return (
        <div className={`${item.noWalletsConnectedText ? "group-hover:bg-secondary-500" : "hover:bg-secondary-500"} flex items-center justify-between w-full overflow-hidden rounded-md p-2 px-4`}>
