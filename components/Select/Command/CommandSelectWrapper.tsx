        ...
        <>
            <div className="flex items-center relative">
                <button
                    ...
                    onClick={openModal}
                    disabled={disabled}
                    className={`rounded-lg focus-peer:ring-primary focus-peer:border-secondary-400 focus-peer:border focus-peer:ring-1 focus:outline-none disabled:cursor-not-allowed relative grow h-12 flex items-center text-left justify-bottom w-full pl-3 pr-4 py-2 bg-secondary-600 border border-secondary-500 font-semibold ${className}`}
                >
                    ...
                    <span className="ml-3 right-0 flex items-center pointer-events-none  text-primary-text">
