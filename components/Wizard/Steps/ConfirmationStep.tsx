...
const ConfirmationStep: FC = () => {
    ...
    const { nextStep, loading } = useWizardState();
    console.log("loading from confirm",loading)
        ...
        <>
                <div className="w-full">
                    ...
                    <div className="mt-3 sm:mt-6 text-white text-sm">
                        <SubmitButton isDisabled={loading} icon={checkButtonIcon} isSubmitting={loading} onClick={nextStep}>
                            Confirm
                        </SubmitButton>
                    </div>
                </div>
