        ...
        <>
            <div className="w-full px-3 md:px-6 md:px-12 py-12 grid grid-flow-row">
                <div>
                    ...
                    <div className="flex items-center">
                        <label className="block text-lg font-normal leading-6 text-light-blue"> Bransfer uses your API keys to access your withrawal history and verify your payments. </label>
                    </div>
