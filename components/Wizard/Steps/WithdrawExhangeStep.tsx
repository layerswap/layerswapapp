                ...
                <div className='mb-12'>
                    ...
                    <div className='mt-1 md:mt-7 block text-base font-lighter leading-6 text-white'>
                        <ul className='list-disc ml-5'>
                            <li>
                                Transaction fee <strong>(27 LRC)</strong> will be refunded to your exchange account.
                            </li>
                            <li>
                                Make sure that <strong>Receive amount</strong> is precisely <strong>100 LRC</strong>
                            </li>
                        </ul>
                    </div>
                </div>
