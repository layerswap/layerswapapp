...
const WithdrawExchangeStep: FC = () => {
    ...
    const availableNetworks = source_exchange?.currencies?.filter(c => c.asset === swap?.source_network_asset && networks.find(n => n.internal_name === c.network).status !== LayerStatus.inactive).map(n => n.network)
