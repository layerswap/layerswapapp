...
import LayerSwapApiClient, { Campaign, Leaderboard, Reward, RewardPayout } from "../../lib/layerSwapApiClient"
                        ...
                        <HeaderWithMenu goBack={handleGoBack} />
                        {
                            campaign ?
                                <div className="space-y-5 px-6">
                                    ...
                                    <LeaderboardComponent campaign={campaign} />
                                    {
...
const Rewards: FC<RewardsProps> = ({ campaign }) => {
    const settings = useSettingsState()
...
const LeaderboardComponent: FC<LeaderboardProps> = ({ campaign }) => {
