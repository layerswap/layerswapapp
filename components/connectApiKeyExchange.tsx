                    ...
                    }
                    {
                        userGuideURL && <div className="flex items-center">
                            <span className="block text-base text-white font-normal leading-6"> Read about
                                <SlideOver ref={slideoverRef} opener={<>&nbsp;<span className="text-base text-primary cursor-pointer underline decoration-primary">How to get API Keys</span>&nbsp;</>} moreClassNames={slideOverClassNames}>
