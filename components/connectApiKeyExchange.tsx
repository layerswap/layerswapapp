                    ...
                    }
                    {
                        userGuideURL && <div className="flex items-center">
                            <span className="block text-base text-white font-normal leading-6"> Read about
                                <SlideOver opener={(open) => <>&nbsp;<a className='text-base text-primary cursor-pointer underline decoration-pink-primary' onClick={() => open()}>How to get API Keys</a>&nbsp;</>} moreClassNames={slideOverClassNames}>
                                    {(close) => (
