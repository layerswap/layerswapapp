...
const ConnectApiKeyExchange: FC<Props> = ({ exchange, onSuccess }) => {
    ...
    return (
        <>
            <div className="w-full px-8 space-y-5 grid grid-flow-row text-pink-primary-300">
                    ...
                    }
                    {
                        userGuideURL && <div className="flex items-center">
                            <span className="block text-base text-white font-normal leading-6"> Read about
                                <SlideOver ref={slideoverRef} opener={<>&nbsp;<span className="text-base text-pink-primary cursor-pointer underline decoration-pink-primary">How to get API Keys</span>&nbsp;</>}>
