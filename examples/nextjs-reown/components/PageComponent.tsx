...
const Comp: FC<{ settings?: LayerSwapSettings }> = ({ settings }) => {
    ...
    return <div className="h-screen flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-gray-400 max-w-lg px-4 text-center">This example demonstrates the Layerswap widget integration using Reown. For information on all available widget configurations, please refer to{' '}
